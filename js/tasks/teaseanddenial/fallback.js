export default {
    ...
    getDifficulty: (difficulty, conditions, difficultyMap) => {
        ...
        // Return VN format
        return {
            image: 'https://picsum.photos/seed/teaseanddenial_fallback/800/600',
            bubbles: [
                '<strong>Tease And Denial Task</strong>',
                `<p>Take ${count} deep, slow breaths while thinking teasing thoughts.</p>`,
                '<p style="font-size: 0.85em; color: #666;"><em>This is a fallback task for the Tease And Denial set. It appears when no other tasks are available.</em></p>'
            ]
        };
    }
};
